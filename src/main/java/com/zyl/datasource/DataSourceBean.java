...
public class DataSourceBean {
	...
	public static class DataSourceBeanBuilder {
		...
		private String url = "jdbc:mysql://%s:%s/%s?%s";
		...
		public DataSourceBeanBuilder(String beanName, String databaseIP, String databasePort, String databaseName,
				String username, String password, String databaseUrlExtraParam) {
			super();
		...
		public String getUrl() {
			return String.format(url,this.databaseIP,this.databasePort,this.databaseName,databaseUrlExtraParam);
		}
		public String getBeanName() {
			return beanName;
		}
